...
public class FlexibleRatingBar extends RatingBar {
	...
	private void init() {
		...
		paintInside.setAntiAlias(true);// 设置画笔的锯齿效果
		paintOutline.setStrokeWidth(strokeWidth);// 设置空心的边框宽度
		paintOutline.setStyle(Paint.Style.STROKE);// 设置画笔风格,空心或实心
	...
	private void getXmlAttrs(Context context, AttributeSet attrs) {
		...
		try {
			...
			strokeWidth = (int) a.getDimension(
					R.styleable.FlexibleRatingBar_strokeWidth, -1);
		} finally {
			a.recycle();
		}
	}
