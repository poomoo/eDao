...
public class KeyManage_Apply_ListViewAdapter extends BaseAdapter {
	...
	public KeyManage_Apply_ListViewAdapter(Context context, List<KeyManageData> list) {
		super();
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.item_listview_key_manage_apply, parent, false);
			holder = new ViewHolder();
			holder.textView_name = (TextView) convertView.findViewById(R.id.item_key_manage_apply_textView_name);
			holder.textView_tel = (TextView) convertView.findViewById(R.id.item_key_manage_apply_textView_tel);
			holder.textView_date = (TextView) convertView.findViewById(R.id.item_key_manage_apply_textView_date);
			holder.button_agree = (Button) convertView.findViewById(R.id.item_key_manage_apply_button_agree);
			holder.button_refuse = (Button) convertView.findViewById(R.id.item_key_manage_apply_button_refuse);
