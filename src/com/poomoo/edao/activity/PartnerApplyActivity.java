...
public class PartnerApplyActivity extends BaseActivity implements
	...
	private EditText editText_money, editText_secret_key,
			editText_merchant_name,editText_address;
	...
	private void init() {
		...
		textView_merchant_type = (TextView) findViewById(R.id.partner_textView_merchant_type);

		editText_money = (EditText) findViewById(R.id.partner_editText_money);
		editText_secret_key = (EditText) findViewById(R.id.partner_editText_secret_key);
		editText_merchant_name = (EditText) findViewById(R.id.partner_editText_merchant_name);
		...
		layout_merchant_type = (LinearLayout) findViewById(R.id.partner_layout_merchant_type);
	...
	public void onClick(View v) {
		...
		case R.id.partner_layout_zone:
			showWindow(layout_zone, listView, list_zone, textView_zone,
					adapter_zone);
			break;
		case R.id.partner_layout_merchant_type:
